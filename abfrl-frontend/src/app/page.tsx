            ...
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/shopkeeper/signup">
                  <Button className="bg-[#FFD166] text-black px-6 py-4 font-mono shadow-retro border-2 border-black hover:bg-[#00CCBF] hover:text-white transition-all flex items-center gap-2">
